...
const storyData = {
    ...
    work: [
        ...
        {
            text: "В первые дни (1-3 день) я занимался внесением новой товарной номенклатуры. Это требовало внимательности, так как любая ошибка могла привести к путанице.",
            bg: "assets/atel.jpg", 
            name: "Даня",
            char: "assets/danya.png"
        },
        ...
        {
            text: "Это кассовое оборудование, с которым я работал. Я заносил товары в базу данных для удобства: чтобы при продаже их можно было просто просканировать по штрих-коду, не вводя цену вручную.",
            bg: "assets/atel.jpg",
            prop: "assets/kassaPractika.png",
            propClass: "centered-xl",
            name: "Даня",
            char: "assets/danya.png"
        },
        {
        ...
        {
            text: "Вот так выглядит база данных на экране монитора. Именно в эту программу я заносил все характеристики товаров, формируя цифровой склад магазина.",
            bg: "assets/atel.jpg",
            prop: "assets/bazaPractika.jpg",
            propClass: "centered-large",
            name: "Даня",
            char: "assets/danya.png"
        },
        {
        ...
        {
            text: "А это один из видов товара, с которым я работал. Например, здесь представлена пряжа различных цветов.",
            bg: "assets/atel.jpg",
            prop: "assets/nitkiPractika.jpg",
            propClass: "centered-large",
            name: "Даня",
            char: "assets/danya.png"
        },
        ...
        {
            text: "Благодаря тому, что я занес эти товары в базу, теперь поддерживать порядок на этих полках и проводить инвентаризацию стало намного проще.",
            bg: "assets/atel.jpg",
            prop: "assets/nitkiPractika2.jpg",
            propClass: "centered-large",
            name: "Даня",
            char: "assets/danya.png"
        },
...
function showSlide() {
    ...
    // Предмет/Скриншот (справа)
    propLayer.className = ''; // Сбрасываем все классы
    if (slide.prop) {
        propImg.src = slide.prop;
        propImg.classList.remove('hidden');
        propImg.style.display = "block";
        
        if (slide.propClass) {
            propLayer.classList.add(slide.propClass);
        }
    } else {
